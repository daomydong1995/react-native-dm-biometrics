...
const LINKING_ERROR =
  `The package 'react-native-dm-biometric' doesn't seem to be linked. Make sure: \n\n` +
  Platform.select({ ios: "- You have run 'pod install'\n", default: '' }) +
  '- You rebuilt the app after installing the package\n' +
  '- You are not using Expo Go\n';

const bridge = NativeModules.ReactNativeDMBiometrics
  ? NativeModules.ReactNativeDMBiometrics
  : new Proxy(
      {},
      {
        get() {
...
export module ReactNativeBiometricsLegacy {
  ...
  export function isSensorAvailable(): Promise<IsSensorAvailableResult> {
    return new ReactNativeDMBiometrics().isSensorAvailable();
  }
  ...
  export function createKeys(): Promise<CreateKeysResult> {
    return new ReactNativeDMBiometrics().createKeys();
  }
  ...
  export function biometricKeysExist(): Promise<BiometricKeysExistResult> {
    return new ReactNativeDMBiometrics().biometricKeysExist();
  }
  ...
  export function deleteKeys(): Promise<DeleteKeysResult> {
    return new ReactNativeDMBiometrics().deleteKeys();
  }
  ...
  export function createSignature(
    ...
    return new ReactNativeDMBiometrics().createSignature(
  ...
  export function simplePrompt(
    ...
    return new ReactNativeDMBiometrics().simplePrompt(simplePromptOptions);
  }

  export function biometricsChanged(): Promise<boolean> {
    return new Promise((resolve, reject) => {
      new bridge.biometricsChanged()
        .then((response: any) => {
...
export default class ReactNativeDMBiometrics {
